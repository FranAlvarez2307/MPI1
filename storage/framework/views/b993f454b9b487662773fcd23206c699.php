                ...
                <div class="col-md-16">
                    <div class="card">
                        <div class="card-header">
                            <?php echo e(__('Ecuaciones Paramétricas')); ?>

                        </div>
                        <div class="card-body">
                            <ul class="nav nav-tabs" role="tablist" >
                                <li class="nav-item"><a class="nav-link active listheader" data-bs-toggle="tab" href="#VID">Ecuaciones Parametricas</a></li>
                                <li class="nav-item"><a class="nav-link  listheader" data-bs-toggle="tab" href="#DR">Elementos de una Curva Paramétrica</a></li>
                                <li class="nav-item"><a class="nav-link  listheader" data-bs-toggle="tab" href="#RF">Tipos de Curvas Paramétricas</a></li>
                            </ul>
...
<?php /**PATH C:\laragon\www\MPI1\resources\views/FuncionesVectoriales/EcuacionesParametricas.blade.php ENDPATH**/ ?>